            ...
            <div className={`${obter === "OBTIDO" ? 'brightness-75' : ''} flex justify-end relative transition ease-in-out duration-500`}>
                ...
                <div className="certificadoCard shadow-md">
                    ...
                    <div className="flex justify-between">
                        <div className="flex h-[35px] min-w-[256px] justify-around items-center px-5 rounded-b-[10px] bg-white">
                            <div className="flex">
                                <h2 className="text-[#00C174] font-medium">POR:</h2>
                                <img className="w-[40px]" src={`../../public/images/grupos/${porGrupoImg}.png`} alt="grupo"/>
                            </div>
                ...
                <img className='h-[125px] border-[#00C174] border-[4px] rounded-[180px] absolute left-0 top-0' src={`../../public/images/certificados/${certificadoImg}.png`} alt="certificado"/>
                <img className={`${obter == 'OBTIDO' ? 'absolute top-2 left-0 pr-[5px] w-[35px] brightness-125': 'hidden'} transition ease-in-out duration-500`} src="../../public/images/obtidoIcon.svg" alt="Obtido Icon"/>
            </div>
        </>
     );
}
