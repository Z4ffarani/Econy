    ...
    return (
        ...
        <div className="flex flex-col items-center">  
            ...
            <div className="grid grid-cols-[320px] sm:grid-cols-[300px_300px] gap-10 mx-auto my-[30px] | sm:my-0 sm:mb-[30px]">
                ...
                <CertificadoCard certificadoImg='ISO50001' nomeCertificado='ISO 1450001' descricaoCertificado='Estabelece requisitos para a implementação, manutenção e melhoria de um Sistema de Gestão de Energia (SGE).' porGrupoImg='SGS'/>
                <CertificadoCard certificadoImg='SBTI' nomeCertificado='SBTi (Science Based Targets initiative)' descricaoCertificado='Auxilia a estabelecer metas de redução de emissões de gases de efeito estufa baseadas na ciência climática.' porGrupoImg='DNV'/>
                <CertificadoCard certificadoImg='IAEA' nomeCertificado='IAEA (International Atomic Energy Agency)' descricaoCertificado='Promove o uso pacífico da energia nuclear e prevenir seu uso para fins militares.' porGrupoImg='DELOITTE'/>
                <CertificadoCard certificadoImg='DJSI' nomeCertificado='DJSI (Dow Jones Sustainability Index)' descricaoCertificado='Avalia e classifica as empresas líderes em sustentabilidade ao redor do mundo.' porGrupoImg='DELOITTE'/>
            </div>
        </div>
        </>
    )
