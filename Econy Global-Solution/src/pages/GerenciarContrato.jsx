                ...
                <>  
                    <div className="flex flex-col justify-center items-center max-w-[320px] gap-2 | sm:w-[640px]">
                        <div className="sm:grid sm:grid-cols-[320px_320px] sm:grid-rows-2">
                            ...
                            <div className="flex flex-col justify-center items-center w-[100%] gap-2 |sm:row-start-2 sm:justify-start sm:gap-0">
                                ...
                                <Link to={'/contratos'}><p className="underline">retornar</p></Link>
                            </div>
                        </div>
                    </div>
                </>
