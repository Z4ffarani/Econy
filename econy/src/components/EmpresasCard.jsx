    ...
    return (
        ...
        <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-between items-center">
                ...
                <button onClick={handleContratar} className={`contratarBtn ${contratar === "CONTRATAR" ? 'bg-transparent border-[2px] border-[#00C174] text-[#00C174]' : 'bg-[#005030] border-[#005030] border-[2px] text-white pointer-events-none'} hover:bg-[#00C174] hover:text-white transition ease-in-out duration-500`}>{contratar}</button>
            </div>
